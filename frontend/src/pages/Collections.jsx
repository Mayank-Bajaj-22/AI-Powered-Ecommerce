...
function Collections() {
    ...
    return (
        <div className='w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-start justify-start flex-col md:flex-row overflow-x-hidden z-[2] pt-[70px]'>
            <div className={`md:w-[30vw] lg:w-[20vw] w-[100vw] md:min-h-[100vh] p-[20px] border-r-[1px] border-gray-400 text-[#aaf5fa] lg:fixed ${ showFilter ? "h-[70vh]" : "h-[8vh]" }`}>
            ...
            <div className='lg:pl-[20%] md:py-[20px]'>
                <div className='md:w-[80vw] w-[100vw] p-[20px] flex justify-between flex-col lg:flex-row lg:px-[50px]'>
                    <Title text1={"ALL"} text2={"COLLECTIONS"} />

                    <select name="" id="" className='bg-slate-600 w-[60%] md:w-[200px] h-[50px] px-[10px] text-white rounded-lg hover:border-[#46d1f7] border-[2px] text-[15px]' onChange={(e) => setSortType(e.target.value)}>
