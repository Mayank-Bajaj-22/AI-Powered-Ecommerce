...
function PlaceOrders() {
    ...
    return (
        <div className='w-[100%] min-h-screen bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center flex-col md:flex-row gap-[50px] relative'>
            <div className='lg:w-[50%] w-[100%] h-[100%] flex items-center justify-center lg:mt-[0px] mt-[90px]'>
                <form action="" onSubmit={onSubmitHandler} className='lg:w-[70%] w-[95%] lg:h-[70%] h-[100%]'>
                    ...
                    <div className='w-[100%] h-[70px] flex items-center justify-between px-[10px]'>
                        ...
                        <input type="text" placeholder='State' className='w-[48%] h-[50px] rounded-md bg-slate-700 shadow-sm shadow-[#343434] placeholder:text-[white] text-[18px] px-[20px]' onChange={onChangeHandler} name='state' value={formData.state} />
                    </div>
