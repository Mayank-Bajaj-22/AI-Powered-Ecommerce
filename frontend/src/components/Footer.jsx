...
function Footer() {
    return (
        <div className='w-[100%] md:h-[36vh] h-[21vh] md:mb-[0px] mb-[160px]'>
            <div className='w-[100%] md:h-[30vh] h-[15vh] md:mb-[0px] bg-[#dbfcfcec] flex items-center justify-center md:px-[50px] px-[5px] py-[60px]'>
                <div className='md:w-[30%] w-[35%] h-[100%] flex justify-center flex-col gap-[5px]'>
                    <div className='flex items-start justify-start gap-[5px] mt-[10px] md:mt-[40px]'>
                        ...
                        <p className='text-[19px] md:text-[20px] text-black'>Vynta</p>
                    </div>
                    ...
                    <p className='text-[15px] text-[#1e2223] flex md:hidden'>
                        Fast. Easy. Reliable. Vnyta
                    </p>
                </div>
                <div className='md:w-[25%] w-[30%] h-[100%] flex items-center justify-center flex-col text-center mr-[15px]'>
            ...
            <div className='w-[100%] text-[15px] h-[5vh] bg-[#dbfcfcec] flex items-center justify-center'>
