        ...
        <div className='w-[100vw] h-[70px] bg-[#ecfafaec] z-10 fixed top-0 flex items-center justify-between px-[30px] shadow-md shadow-black'>
            ...
            <div className='w-[50%] lg:w-[40%] hidden md:flex'>
                <ul className='flex items-center justify-center gap-[19px] text-white'>
                    <li className='text-[15px] hover:bg-slate-600 cursor-pointer bg-[#000000c9] py-[10px] px-[20px] rounded-2xl' onClick={() => navigate("/")}>HOME</li>
                    <li className='text-[15px] hover:bg-slate-600 cursor-pointer bg-[#000000c9] py-[10px] px-[20px] rounded-2xl' onClick={() => navigate("/collection")}>COLLECTIONS</li>
                    <li className='text-[15px] hover:bg-slate-600 cursor-pointer bg-[#000000c9] py-[10px] px-[20px] rounded-2xl' onClick={() => navigate("/about")}>ABOUT</li>
                    <li className='text-[15px] hover:bg-slate-600 cursor-pointer bg-[#000000c9] py-[10px] px-[20px] rounded-2xl' onClick={() => navigate("/contact")}>CONTACT</li>
                </ul>
            </div>
            ...
            <div className='w-[100vw] h-[70px] flex items-center justify-between px-[20px] fixed bottom-0 left-0 bg-[#191818] md:hidden text-[13px]'>
                <button className='text-white flex items-center justify-center flex-col gap-[4px]'>
                    <IoMdHome className='w-[25px] h-[25px] text-white md:hidden' onClick={() => navigate("/")} /> Home
                </button>
                <button className='text-white flex items-center justify-center flex-col gap-[4px] mt-[5px]'>
                    <BsCollectionFill className='w-[22px] h-[22px] text-white md:hidden' onClick={() => navigate("/collection")} /> Collections
                </button>
                <button className='text-white flex items-center justify-center flex-col gap-[4px] mt-[4px]'>
                    <MdContacts className='w-[23px] h-[23px] text-white md:hidden' onClick={() => navigate("/contact")} /> Contact
                </button>
                <button className='text-white flex items-center justify-center flex-col gap-[4px] mt-[4px]'  onClick={() => navigate("/cart")}>
