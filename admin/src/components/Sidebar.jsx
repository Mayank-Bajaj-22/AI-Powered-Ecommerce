...
function Sidebar() {
    ...
    return (
        <div className='w-[18%] min-h-[100vh] border-r-[1px] py-[35px] fixed left-0 top-[70px]'>
            <div className='flex flex-col gap-4 pl-[20%] text-[15px]'>

                <div className='flex items-center justify-center md:justify-start gap-2 border border-gray-200 border-r-0 px-3 py-2 cursor-pointer hover:bg-[#2c7b89]' onClick={() => navigate("/add")}>
