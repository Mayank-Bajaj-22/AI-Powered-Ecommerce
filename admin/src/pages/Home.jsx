...
function Home() {
    ...
    return (
        ...
        <div className="w-[70vw] h-[100vh] absolute left-[25%] flex items-Start justify-start flex-col gap-[30px] py-[90px]">
            <h1 className="text-[35px] text-[#afe2f2]">OneCart Admin Panel</h1>
            <div className="flex items-center justify-start gap-[30px] md:gap-[50px] flex-col md:flex-row">
